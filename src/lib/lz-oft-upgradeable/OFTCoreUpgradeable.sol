...
import { OAppUpgradeable, Origin } from "src/lib/lz-oapp-upgradeable/OAppUpgradeable.sol";
    ...
    OAppOptionsType3Upgradeable
{
     ...
     */
    function __OFTCore_init(address _delegate, uint8 _localDecimals, address _endpoint) internal onlyInitializing {
        __OApp_init(_delegate, _endpoint);
