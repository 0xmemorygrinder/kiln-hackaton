...
abstract contract OFTUpgradeable is OFTCoreUpgradeable, ERC20Upgradeable {
     ...
     */
    function __OFT_init(address _lzEndpoint, string memory _name, string memory _symbol, address _delegate) internal onlyInitializing {
        __ERC20_init(_name, _symbol);
        __OFTCore_init(_delegate, decimals(), _lzEndpoint);
    }
