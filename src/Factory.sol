...
/// @author 0xtekgrinder
contract Factory is ERC1967Factory {
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    ...
    function deployStablecoin(address curator, address treasury, MetaVaultArguments calldata vaultInitData) external {
        StablecoinAddresses memory stablecoinAddresses;
        ...
        MetaVault(metaVault).init(accessControl, vaultInitData.endpoint, vaultInitData.name, vaultInitData.symbol, vaultInitData.decimals);
